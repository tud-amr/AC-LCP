...
class SetTransformers(TFModelV2):
    ...
    def __init__(self, obs_space, action_space, num_outputs, model_config,
        ...
        super(SetTransformers, self).__init__(
        ...
        # target_seq = tf.reshape(input_targets_all, (batch_size, -1, child_dim))
        ...
        self.output_inputs_model = tf.keras.Model(inputs, [target_seq])
