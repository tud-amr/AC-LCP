...
def run(args, parser,in_evaluation=None,evaluation_config=None):
    config = {}
    ...
    if evaluation_config is None: # MODIFIED
...
def rollout(agent,
    ...
    if video_dir and False: # MODIFIED!!! take out monitor function
