...
if __name__ == '__main__':
    ...
    lh_ratio += [1] * len(addendum)
    seeds += [len(addendum)] * int(len(addendum) != 0)
    env_mode_name += ['Single-target pre OM'] * int(len(addendum) != 0)
    plot_curve += [True] * int(len(addendum) != 0)
    ...
    lh_ratio += [1] * len(addendum)
    seeds += [len(addendum)] * int(len(addendum) != 0)
    env_mode_name += ['Single-target current OM'] * int(len(addendum) != 0)
    plot_curve += [True] * int(len(addendum) != 0)
    ...
    lh_ratio += [1] * len(addendum)
    seeds += [len(addendum)] * int(len(addendum) != 0)
    env_mode_name += ['Single-target current OM 6000'] * int(len(addendum) != 0)
    plot_curve += [True] * int(len(addendum) != 0)
